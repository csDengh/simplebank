...
type SimpleBankClient interface {
	...
	LoginUser(ctx context.Context, in *UserLoginReq, opts ...grpc.CallOption) (*UserLoginRes, error)
}
...
func (c *simpleBankClient) LoginUser(ctx context.Context, in *UserLoginReq, opts ...grpc.CallOption) (*UserLoginRes, error) {
...
type SimpleBankServer interface {
	...
	LoginUser(context.Context, *UserLoginReq) (*UserLoginRes, error)
...
func (UnimplementedSimpleBankServer) LoginUser(context.Context, *UserLoginReq) (*UserLoginRes, error) {
...
func _SimpleBank_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).LoginUser(ctx, req.(*UserLoginReq))
	}
	return interceptor(ctx, in, info, handler)
}
