...
// Source: github.com/csdengh/cur_blank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 *db.TransferTxParams) *db.TransferTxResult {
	m.ctrl.T.Helper()
